...
)
{
    ...
    {
        return view(
            'dashboard.buyer.messenger.index'
        );
    }
...
$search = request('search');
    ...
    return response()->json([
        ...
        'conversations' =>
            $conversations->map(function ($conversation) use ($buyerType, $buyerId) {
                ...
                $participant =
                    $conversation
                        ->participants
                        ->first(function ($participant) use ($buyerType, $buyerId) {

                            return
                                $participant->context_type === $buyerType
                                && (int) $participant->context_id === (int) $buyerId;
