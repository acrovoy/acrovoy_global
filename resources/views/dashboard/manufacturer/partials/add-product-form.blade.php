...
<form method="POST"
    ...
    <div class="form-step" data-step="1">
        ...
        @include('dashboard.manufacturer.sections.step1')

    </div>

    <div class="form-step hidden" data-step="2">

        @include('dashboard.manufacturer.sections.step2')

    </div>

    <div class="form-step hidden" data-step="3">

        @include('dashboard.manufacturer.sections.step3')
    ...
    <div class="form-step hidden" data-step="5">
        ...
        @include('dashboard.manufacturer.sections.step5')
    ...
    <div class="form-step hidden" data-step="6">
        ...
        @include('dashboard.manufacturer.sections.step6')
