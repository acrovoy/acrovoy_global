...
<div x-data="{
    ...
    @foreach($order['items'] as $item)
        ...
        @if($order['provider_type'] === \App\Models\LogisticCompany::class)
            ...
            <div x-data="pickupModal()" x-cloak>
                ...
                @include('dashboard.supplier.modals.address_dimensions', ['countries' => $countries])
            </div>
    ...
    {{-- Invoice for product --}}
@include('dashboard.supplier.partials.invoice-order', ['order_items' => $order_items, 'order' => $order])
