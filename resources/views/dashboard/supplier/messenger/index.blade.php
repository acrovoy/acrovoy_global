...
<div class="h-[calc(100vh-80px)]">
    ...
    <div class="h-full min-h-0 bg-white border border-stone-200 rounded-xl shadow-sm overflow-hidden flex">
        ...
        {{-- SIDEBAR --}}
        <aside
    class="w-[360px] shrink-0 h-full min-h-0 flex flex-col border-r border-stone-200 bg-white"
>

            @include(
                'dashboard.supplier.messenger.partials.sidebar'
            )
        ...
        >
            ...
            >
                ...
                @include(
                    'dashboard.supplier.messenger.partials.header'
                )
            ...
            >
                ...
                @include(
                    'dashboard.supplier.messenger.partials.messages'
                )
            ...
            >
                ...
                @include(
                    'dashboard.supplier.messenger.partials.composer'
                )
