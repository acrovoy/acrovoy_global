...
<h2 class="text-2xl font-bold mb-4">Create New Premium Plan</h2>

<form action="{{ route('admin.premium-plans.store') }}" method="POST" class="space-y-6 bg-white p-6 rounded shadow">
    @csrf
