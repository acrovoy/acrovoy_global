...
$customizationCategory = 84;
@endphp


{{-- BACK --}}
<a href="{{ route('buyer.projects.show', ['project' => $project->id]) }}"
...
<div class="bg-white border border-gray-200 rounded-lg shadow-sm p-5">
    ...
    <form method="GET" class="mb-6">
        ...
        <select name="category_id"
                @disabled($rfq->category_id === $customizationCategory)
                @unless($rfq->category_id === $customizationCategory)
