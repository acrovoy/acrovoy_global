...
<div class="flex items-center justify-center bg-white min-h-screen">
    <div class="w-full max-w-md px-8">
        ...
        <form method="POST" action="{{ route('password.email') }}" class="space-y-4">
            ...
            <button
                type="submit"
                class="w-full py-3 text-lg font-semibold text-white bg-[#1877f2] rounded-md hover:bg-[#166fe5] transition"
            >
            ...
            <!-- Back to login -->
            <a href="{{ route('login') }}"
               class="block w-full text-center py-3 text-lg font-semibold text-white bg-[#42b72a] rounded-md hover:bg-[#36a420]">
                Back to Login
            </a>
